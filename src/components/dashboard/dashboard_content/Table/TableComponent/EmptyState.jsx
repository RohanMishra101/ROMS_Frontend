// src/pages/TableComponent/EmptyState.jsx
export default function EmptyState({ onAddTable }) {
  return (
    <div className="bg-white rounded-xl shadow-sm p-8 text-center">
      ...
      <p className="mt-2 text-gray-500">Get started by adding your first restaurant table.</p>
      <div className="mt-6">
        <button
          onClick={onAddTable}
