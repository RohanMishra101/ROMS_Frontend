...
export default function CartSidebar({
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-16 md:top-20 right-0 h-[calc(100vh-4rem)] md:h-[calc(100vh-5rem)] w-full md:w-96 bg-white shadow-lg z-50 transform transition-transform duration-300 flex flex-col
      ...
      >
        ...
        <div className="flex justify-between items-center p-4 border-b flex-shrink-0">
          ...
          <button onClick={toggleCart} className="md:hidden">
            <FiX size={24} />
          </button>
        </div>
